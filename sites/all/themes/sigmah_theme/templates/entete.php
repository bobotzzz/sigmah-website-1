...
gestion des menus d�roulants :
    ...
    Si la li � la class 'hassub_menu', il y a un menu d�roulant qui va avec, sinon, class 'hasnsub_menu'
    Quand on est dans une page, le lien a la class 'select', et c'est le seul a l'avoir.
    L'id d'un li qui a un sous menu, doit correspondre a l'id du sous menu a d�rouler en y rajoutant 'sub_'
